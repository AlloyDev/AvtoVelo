...
- (void)viewDidLoad
{
    ...
    [wv loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://avtovelo.ru/index.php?option=com_tienda&view=products&filter_category=33&Itemid=83"]]];
}
